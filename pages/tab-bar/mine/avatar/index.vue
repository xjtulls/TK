  ...
  <view class="container">
    <view class="page-body uni-content-info">
      ...
      <view class='cropper-config'>
        <u-button plain shape="circle" type="primary" style='margin-top: 30rpx;width: 80%' @click="getImage"> 选择头像
        </u-button>
        <u-button plain shape="circle" type="success" style='margin-top: 30rpx;width: 80%' @click="getImageInfo"> 保存
        </u-button>
      </view>
      <canvas
    ...
    getImageInfo() {
      ...
      ctx.draw(true, () => {
        ...
        uni.canvasToTempFilePath({
          ...
          success: function (res) {
            uni.hideLoading()
            let data = {name: 'avatar', filePath: res.tempFilePath}
            uploadAvatar(data).then(response => {
              store.commit('SET_AVATAR', response.url)
